---
id: source-events-ships
type: source
source_kind: gamedata
raw: raw/gamedata/events_ships.xml
game_version: ae
ingested: 2026-08-09
reliability: high
tags: [partial-ingest]
...
## Summary
Enemy ship definitions referenced by events: surrender offers, escape behaviour, crew and loot. Contains no `<event name=>` definitions of its own - it defines the ships events point at.
