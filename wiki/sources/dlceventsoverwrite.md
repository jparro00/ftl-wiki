---
id: source-dlceventsoverwrite
type: source
source_kind: gamedata
raw: raw/gamedata/dlcEventsOverwrite.xml
game_version: ae
ingested: 2026-08-09
reliability: high
tags: [partial-ingest]
...
## Summary
Event lists that **replace** base-file lists when Advanced Edition is enabled. This file is the mechanical basis of the `ae` vs `vanilla` distinction.

Contains **12 event lists**, 8 KB.
